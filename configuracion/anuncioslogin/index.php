...
$folder="../../";
$titulo="NModificarComunicadosLogin";

include_once($folder."cabecerahtml.php");
?>
<script language="javascript" type="text/javascript" src="../../js/configuracion/anuncionslogin.js"></script>
...
<div class="span8 box">
	<div class="box-header"><h2><?php echo $idioma['ListadoMensajes']?></h2></div>
