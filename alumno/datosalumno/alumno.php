...
<div class="box span6">
	...
	<div class="box-content">
        <table border="0" class="tabla table-hover">
            <tr>
                ...
                <td><?php campo("Matricula","text",$al['CodAlumno'],"span12",1,"",0,array("readonly"=>"readonly"))?></td>
            </tr>
            <tr>
        ...
        <table class="tabla table-hover">
            ...
            <tr>
             ...
             <tr>
                ...
                <td><?php campo("FechaRetiro","text",$al['FechaRegistro'],"span12",0,"",0,array("maxlength"=>10))?>(Ej:23-07-1990)</td>
             </tr>
             <tr>
 ...
 <div class="box span6">
	...
	<div class="box-content">
		<table class="tabla">
			<tr>
                ...
                <td><?php campo("CertificadoNac","select",$sinovalor,"span12",0,"",0,array("maxlength"=>50),$doc['CertificadoNac'])?></td>
            </tr>
            <tr>
            	<td class="der"><?php echo $idioma['LibretaEscolar']?></td>
                <td><?php campo("LibretaEsc","select",$sinovalor,"span12",0,"",0,array("maxlength"=>50),$doc['LibretaEsc'])?></td>
            </tr>
            <tr>
             	<td class="der"><?php echo $idioma['LibretaVacunas']?></td>
                <td><?php campo("LibretaVac","select",$sinovalor,"span12",0,"",0,array("maxlength"=>50),$doc['LibretaVac'])?></td>
            </tr>
            <tr>
             	<td class="der"><?php echo $idioma['CiAlumno']?></td>
                <td><?php campo("CedulaId","select",$sinovalor,"span12",0,"",0,array("maxlength"=>50),$doc['CedulaId'])?></td>
            </tr>
			<tr>
            	<td class="der"><?php echo $idioma['CiPadre']?></td>
    ...
    <div class="box-content">
    	<input type="submit" value="<?php echo $idioma['ActualizarDatosAlumno']?>" class="btn btn-success"/>
