	...
	<div class="box-content">
        <table border="0" class="tabla table-hover">
            ...
            <tr class="">
                ...
                <td><?php campo("ActivarSMS","select",array("0"=>$idioma['No'],"1"=>$idioma['Si']),"span12",0,"",0,array("maxlength"=>30),$al["ActivarSMS"])?></td>
            </tr>
            <tr>
 ...
 <div class="box span6">
	...
	<div class="box-content">
		<table class="tabla">
            ...
            <tr>
            	<td class="der"><?php echo $idioma['ObservacionesDocumentos']?></label></td>
