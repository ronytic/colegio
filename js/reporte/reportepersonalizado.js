...
function respuesta1(data){
	...
	$("#formulario").submit(function(e) {
		...
		$.post("ver.php",{"CodCurso":CodCurso,"Sexo":Sexo,"Campo1":Campo1,"Campo2":Campo2,"Campo3":Campo3,"Campo4":Campo4,"Borde":Borde,"Blanco":Blanco,"Cantidad":Cantidad,"Sombreado":Sombreado},function(data){
			$("#respuesta").html(data);
		});
