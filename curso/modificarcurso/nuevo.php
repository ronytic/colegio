...
if(isset($_POST)){
    ...
    <table class="table table-bordered table-striped">
        ...
        <tr>
        	...
        	<input type="text" value="<?php echo $cur['Abreviado']?>" name="Abreviado" class="span12" placeholder="1 Prim"></td>
        </tr>
        <tr>
        ...
        <tr>
        	...
        	<input type="text" value="<?php echo $cur['NotaTope']?>" name="NotaTope" class="span12" placeholder="60"></td>
        </tr>
        <tr>
        ...
        <tr>
        	...
        	<input type="text" value="<?php echo $cur['Orden']?>" name="Orden" class="span12" placeholder="14"><br>
