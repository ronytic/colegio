...
<table class="table table-bordered table-striped table-hover">
                ...
                <tr class="<?php echo $acEstado?'completado':''?>">
                    ...
                    <?php if(($Botones=="1") && $ac['Nivel']==$Nivel && $ac['CodUsuario']==$CodUsuario){?><td><button class="btn btn-mini" id="modificar" rel="<?php echo $ac['CodAgendaActividades']?>" title="<?php echo $idioma['Modificar']?>"><i class="icon-pencil"></i></button> <button class="btn btn-mini" id="eliminar" rel="<?php echo $ac['CodAgendaActividades']?>" title="<?php echo $idioma['Eliminar']?>"><i class="icon-remove"></i></button></td><?php }?>
                </tr>
                <?php }?>
            </table><?php	
}else{
