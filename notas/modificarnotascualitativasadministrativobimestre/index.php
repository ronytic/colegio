...
$titulo="NRegistroNotasCualitativasGlobal";
$folder="../../";
$docente=new docente;
$curso=new curso;
...
<div class="box-content">
	<div class="row-fluid">
    	<div class="span12 resaltar">
        <?php echo $idioma['Docente']?>: <?php echo capitalizar($doc['Paterno'])?> <?php echo capitalizar($doc['Materno'])?> <?php echo capitalizar($doc['Nombres'])?>
        </div>
    </div>
    <div class="row-fluid">
        <div class="span3">
