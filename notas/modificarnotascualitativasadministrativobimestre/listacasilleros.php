...
if(!empty($_POST)){
	...
	$cur=array_shift($cur);
	$notascuali=$notascualitativabimestre->mostrarTodoRegistro("Periodo=$CodPeriodo and CodCurso=$CodCurso");
	$notascuali=array_shift($notascuali);
	$CodNotasCualitativa=$notascuali['CodNotasCualitativaBimestre'];
