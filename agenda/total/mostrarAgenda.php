...
if(isset($_POST)){
    ...
    <thead>
    	<tr class="cabecera"><th width="20" style="min-width:20px;"></th><th width="20"><?php echo $idioma['Materia']?></th><th width="100"><?php echo $idioma['Observacion']?></th><th><?php echo $idioma['Detalle']?></th><th width="75"><?php echo $idioma['Fecha']?></th><th></th></tr>
        </thead>
        <?php
