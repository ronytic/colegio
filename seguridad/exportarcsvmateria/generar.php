...
if(!empty($_GET)){
	...
	$cnf=array_shift($config->mostrarConfig("InicioTrimestre1"));
	$InicioTrimestre1=$cnf['Valor'];
	$cnf=array_shift($config->mostrarConfig("FinTrimestre1"));
	$FinTrimestre1=$cnf['Valor'];
	$cnf=array_shift($config->mostrarConfig("InicioTrimestre2"));
	$InicioTrimestre2=$cnf['Valor'];
	$cnf=array_shift($config->mostrarConfig("FinTrimestre2"));
	$FinTrimestre2=$cnf['Valor'];
	$cnf=array_shift($config->mostrarConfig("InicioTrimestre3"));
	$InicioTrimestre3=$cnf['Valor'];
	$cnf=array_shift($config->mostrarConfig("FinTrimestre3"));
