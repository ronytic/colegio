    ...
    <table class="table table-bordered table-hover">
    	<tr>
        	<td colspan="2">
                ...
                <input type="file" name="foto" placeholder="Ingrese">
    		</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><?php campo("Sexo","select",array(1=>'Masculino',0=>'Femenino'),"span12",1,"",0,"",$doc['Sexo'])?></td>
        </tr>
        <tr>
            <td><?php echo $idioma['Ci']?></td>
            <td><?php campo("Sexo","text",$doc['Ci'],"span12",1,$idioma['IngreseSu'].$idioma['Ci'],0,"")?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><?php campo("Departamento","text",$doc['Departamento'],"span12"); ?></td>
        </tr>
        <tr>
            <td><?php echo $idioma['Provincia']?></td>
            <td><?php campo("Provincia","text",$doc['Provincia'],"span12",$idioma['IngreseSu'].$idioma['Provincia']); ?></td>
        </tr>
...
<div class="box-content">
	<table class="table table-bordered table-hover">
    	<tr>
            ...
            <td><?php campo("DPTitulo","text",$doc['DTCargo'],"span12",1,$idioma['IngreseSu'].$idioma['Cargo']); ?></td>
        </tr>
        <tr>
            <td><?php echo $idioma['CargaHoraria']?></td>
            <td><?php campo("DPTitulo","text",$doc['DTCargaHoraria'],"span12",1,$idioma['IngreseSu'].$idioma['CargaHoraria']); ?></td>
        </tr>
        <tr>
            <td><?php echo $idioma['Antiguedad']?></td>
            <td><?php campo("DPTitulo","text",$doc['DTAntiguedad'],"span12",1,$idioma['IngreseSu'].$idioma['Antiguedad']); ?></td>
        </tr>
        <tr>
            <td><?php echo $idioma['Categoria']?></td>
            <td><?php campo("DPTitulo","text",$doc['DTCategoria'],"span12",1,$idioma['IngreseSu'].$idioma['Categoria']); ?></td>
        </tr>
        <tr>
            <td><?php echo $idioma['Observacion']?></td>
            <td><?php campo("DPTitulo","text",$doc['Observacion'],"span12",1,$idioma['IngreseSu'].$idioma['Observacion']); ?></td>
        </tr>
    </table>
