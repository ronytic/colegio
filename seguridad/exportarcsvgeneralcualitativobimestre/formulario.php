...
if(!empty($_POST)){
    ...
    <label for="separadorcualitativo"><?php echo $idioma['SeparadorCualitativo']?></label>
    <input name="separadorcualitativo" id="separadorcualitativo" size="3" type="text" class="span12"/>
