...
<div class="box span3">
    ...
    <div class="box-content">
    	<table class="table table-bordered table-hover table-condensed">
        	...
        	<tr class="fecha"><td><?php echo $idioma['Desde']?></td><td><input type="text" size="15" name="DesdeFecha" id="DesdeFecha" class="der input-small span12" value="<?php echo date("d-m-Y")?>"/></td></tr>
            <tr class="fecha"><td><?php echo $idioma['Hasta']?></td><td><input type="text" size="15" name="HastaFecha" id="HastaFecha" value="<?php echo date("d-m-Y")?>" class="der input-small span12"/></td></tr>
